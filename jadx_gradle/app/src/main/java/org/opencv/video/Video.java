...
public class Video {
    ...
    public static RotatedRect CamShift(Mat probImage, Rect window, TermCriteria criteria) {
        ...
        RotatedRect retVal = new RotatedRect(CamShift_0(probImage.nativeObj, window.f101x, window.f102y, window.width, window.height, window_out, criteria.type, criteria.maxCount, criteria.epsilon));
        if (window != null) {
            window.f101x = (int) window_out[0];
            window.f102y = (int) window_out[1];
    ...
    public static int meanShift(Mat probImage, Rect window, TermCriteria criteria) {
        double[] window_out = new double[4];
        int retVal = meanShift_0(probImage.nativeObj, window.f101x, window.f102y, window.width, window.height, window_out, criteria.type, criteria.maxCount, criteria.epsilon);
        if (window != null) {
            window.f101x = (int) window_out[0];
            window.f102y = (int) window_out[1];
            window.width = (int) window_out[2];
