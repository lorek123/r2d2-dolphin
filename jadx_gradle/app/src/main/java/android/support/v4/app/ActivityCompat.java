...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(@NonNull Activity activity, @NonNull String[] permissions, @IntRange(from = 0) int requestCode) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            handler.post(new Runnable() { // from class: android.support.v4.app.ActivityCompat.1
                ...
                RunnableC00191(String[] permissions2, Activity activity2, int requestCode2) {
                    r1 = permissions2;
                    r2 = activity2;
                    r3 = requestCode2;
                }
                ...
                public void run() {
                    int[] grantResults = new int[r1.length];
                    PackageManager packageManager = r2.getPackageManager();
                    String packageName = r2.getPackageName();
                    int permissionCount = r1.length;
                    for (int i = 0; i < permissionCount; i++) {
                        grantResults[i] = packageManager.checkPermission(r1[i], packageName);
                    }
                    ((OnRequestPermissionsResultCallback) r2).onRequestPermissionsResult(r3, r1, grantResults);
                }
            });
        }
    }
    ...
    static class RunnableC00191 implements Runnable {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ String[] val$permissions;
        final /* synthetic */ int val$requestCode;
    ...
    private static class SharedElementCallback23Impl extends ActivityCompatApi23.SharedElementCallback23 {
        ...
        class C00201 implements SharedElementCallback.OnSharedElementsReadyListener {
            final /* synthetic */ ActivityCompatApi23.OnSharedElementsReadyListenerBridge val$listener;

            C00201(ActivityCompatApi23.OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
                r2 = onSharedElementsReadyListenerBridge;
            }

            @Override // android.support.v4.app.SharedElementCallback.OnSharedElementsReadyListener
            public void onSharedElementsReady() {
                r2.onSharedElementsReady();
            }
        }

        @Override // android.support.v4.app.ActivityCompatApi23.SharedElementCallback23
        public void onSharedElementsArrived(List<String> sharedElementNames, List<View> sharedElements, ActivityCompatApi23.OnSharedElementsReadyListenerBridge listener) {
            this.mCallback.onSharedElementsArrived(sharedElementNames, sharedElements, new SharedElementCallback.OnSharedElementsReadyListener() { // from class: android.support.v4.app.ActivityCompat.SharedElementCallback23Impl.1
                ...
                C00201(ActivityCompatApi23.OnSharedElementsReadyListenerBridge listener2) {
                    r2 = listener2;
                }
