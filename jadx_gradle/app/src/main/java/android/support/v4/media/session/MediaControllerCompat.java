    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        private class ExtraCallback extends IMediaControllerCallback.Stub {
            ...
            class RunnableC01011 implements Runnable {
                ...
                RunnableC01011(String str, Bundle bundle) {
                    r2 = str;
                    r3 = bundle;
                }
                ...
                public void run() {
                    ExtraCallback.this.mCallback.onSessionEvent(r2, r3);
                }
            }
            ...
            public void onEvent(String event, Bundle extras) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.1
                    ...
                    RunnableC01011(String event2, Bundle extras2) {
                        r2 = event2;
                        r3 = extras2;
                    }
            ...
            class RunnableC01022 implements Runnable {
                final /* synthetic */ PlaybackStateCompat val$state;

                RunnableC01022(PlaybackStateCompat playbackStateCompat) {
                    r2 = playbackStateCompat;
                }

                @Override // java.lang.Runnable
                public void run() {
                    ExtraCallback.this.mCallback.onPlaybackStateChanged(r2);
                }
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat state) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.2
                    ...
                    RunnableC01022(PlaybackStateCompat state2) {
                        r2 = state2;
                    }
            ...
            class RunnableC01033 implements Runnable {
                final /* synthetic */ int val$repeatMode;

                RunnableC01033(int i) {
                    r2 = i;
                }

                @Override // java.lang.Runnable
                public void run() {
                    ExtraCallback.this.mCallback.onRepeatModeChanged(r2);
                }
            }
            ...
            public void onRepeatModeChanged(int repeatMode) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.3
                    ...
                    RunnableC01033(int repeatMode2) {
                        r2 = repeatMode2;
                    }
            ...
            class RunnableC01044 implements Runnable {
                final /* synthetic */ boolean val$enabled;

                RunnableC01044(boolean z) {
                    r2 = z;
                }

                @Override // java.lang.Runnable
                public void run() {
                    ExtraCallback.this.mCallback.onShuffleModeChanged(r2);
                }
            }
            ...
            public void onShuffleModeChanged(boolean enabled) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.4
                    ...
                    RunnableC01044(boolean enabled2) {
                        r2 = enabled2;
                    }
