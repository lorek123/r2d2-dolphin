...
public class Toolbar extends ViewGroup {
    ...
    class C02511 implements ActionMenuView.OnMenuItemClickListener {
        C02511() {
        }
    ...
    class RunnableC02522 implements Runnable {
        RunnableC02522() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        titleMargin = a.hasValue(C0205R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C0205R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
