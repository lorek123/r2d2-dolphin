...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    class C02082 implements MenuItemHoverListener {
        C02082() {
        }
        ...
        @Override // android.support.v7.widget.MenuItemHoverListener
        public void onItemHoverEnter(@NonNull MenuBuilder menu2, @NonNull MenuItem item2) {
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            FrameLayout titleItemView = (FrameLayout) from.inflate(C0205R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
