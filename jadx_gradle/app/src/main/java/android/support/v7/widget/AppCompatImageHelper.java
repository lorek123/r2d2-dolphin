...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            if (drawable == null && (id = (a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0205R.styleable.AppCompatImageView, defStyleAttr, 0)).getResourceId(C0205R.styleable.AppCompatImageView_srcCompat, -1)) != -1 && (drawable = AppCompatResources.getDrawable(this.mView.getContext(), id)) != null) {
