...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int layoutResId = a.getResourceId(C0205R.styleable.SearchView_layout, C0205R.layout.abc_search_view);
        inflater.inflate(layoutResId, (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0205R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0205R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0205R.id.search_plate);
        this.mSubmitArea = findViewById(C0205R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0205R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0205R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0205R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0205R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0205R.id.search_mag_icon);
        ...
        boolean focusable = a.getBoolean(C0205R.styleable.SearchView_android_focusable, true);
