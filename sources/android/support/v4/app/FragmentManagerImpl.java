...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    class C00292 extends AnimateOnHWLayerIfNeededListener {
        final /* synthetic */ Fragment val$fragment;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00292(View v, Animation anim, Fragment fragment) {
            super(v, anim);
            r4 = fragment;
        }
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (r4.getAnimatingAway() != null) {
                r4.setAnimatingAway(null);
                FragmentManagerImpl.this.moveToState(r4, r4.getStateAfterAnimating(), 0, 0, false);
            }
        }
    }
