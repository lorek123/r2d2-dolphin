...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0205R.layout.abc_dialog_title_material, (ViewGroup) null);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0205R.layout.abc_screen_toolbar, (ViewGroup) null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0205R.id.decor_content_parent);
            ...
            if (this.mOverlayActionMode) {
                subDecor = (ViewGroup) inflater.inflate(C0205R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                subDecor = (ViewGroup) inflater.inflate(C0205R.layout.abc_screen_simple, (ViewGroup) null);
            }
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C0205R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0205R.id.action_bar_activity_content);
    ...
    class C01922 implements OnApplyWindowInsetsListener {
        C01922() {
        }
    ...
    class C01933 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        C01933() {
        }
    ...
    class C01944 implements ContentFrameLayout.OnAttachListener {
        C01944() {
        }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0205R.attr.actionModePopupWindowStyle);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0205R.id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    class RunnableC01955 implements Runnable {
        RunnableC01955() {
        }
    ...
    class C01966 extends ViewPropertyAnimatorListenerAdapter {
        C01966() {
        }
    ...
    private void openPanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (wm != null && preparePanel(st, event)) {
                ...
                st.isHandled = false;
                WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f25x, st.f26y, 1002, 8519680, -3);
