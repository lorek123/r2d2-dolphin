...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (defStyleRes != 0 && sdk < 11 && a.hasValue(C0205R.styleable.PopupWindow_android_popupAnimationStyle)) {
            setAnimationStyle(a.getResourceId(C0205R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
        a.recycle();
