...
import android.support.constraint.C0002R;
...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_rotation, 60);
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintCircle, 61);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_id, 38);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0002R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0002R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0002R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0002R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
    ...
    private static class Constraint {
        ...
        /* synthetic */ Constraint(C00011 x0) {
            this();
        }
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            this.mConstraints.put(key, set.mConstraints.get(key).m22clone());
        }
    }
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                Field field = C0002R.id.class.getField(idString);
