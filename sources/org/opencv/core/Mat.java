...
public class Mat {
    ...
    public Mat(Mat m, Rect roi) {
        this.nativeObj = n_Mat(m.nativeObj, roi.f102y, roi.f102y + roi.height, roi.f101x, roi.f101x + roi.width);
    }
    ...
    public Mat submat(Rect roi) {
        Mat retVal = new Mat(n_submat(this.nativeObj, roi.f101x, roi.f102y, roi.width, roi.height));
        return retVal;
    }
